...
2. Use `lean_diagnostic_messages` to verify it compiles
...
- `lean_goal`: Understand proof state at each step
- `lean_diagnostic_messages`: Verify changes compile
- `lean_file_outline`: Understand overall structure
